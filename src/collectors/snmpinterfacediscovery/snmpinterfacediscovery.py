...
Below is an example configuration for the SNMPInterfaceDiscoveryCollector. The collector
...
class SNMPInterfaceDiscoveryCollector(parent_SNMPCollector):
    ...
    def get_default_config(self):
        ...
        default_config = super(SNMPInterfaceDiscoveryCollector, self).get_default_config()
