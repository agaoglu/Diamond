...
"""
The SNMPInterfacePollCollector is designed for collecting interface data from
remote SNMP-enabled devices such as routers and switches using SNMP IF_MIB

#### Installation

The SNMPInterfacePollCollector.py module should be installed into your Diamond
...
The SNMPInterfacePollCollector.cfg file should be installed into your diamond
...
The SNMPInterfacePollCollector relies on oids.lst, which is generated by another
...
class SNMPInterfacePollCollector(parent_SNMPCollector):

    def get_default_config(self):
        """
        Override SNMPCollector.get_default_config method to provide
        default_config for the SNMPInterfacePollCollector
        """
    ...
    def publish_metrics(self, gaugesList, countersList, timestamp):
        ...
        for counterDesc in countersList:
            ...
            if metricPath == 'ERROR:':
                ...
                try:
                  metric = Metric(metricPath, metricValue,
                                  raw_value=None,
                                  timestamp=timestamp
                                  )
                  self.publish_metric(metric)
    ...
    def collect_snmp(self, device, host, port, community):
        ...
        oidFilename = '/etc/diamond/collectors/SNMPInterfacePollCollector.d/oids.lst'
